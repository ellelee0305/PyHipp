...
class Waveform(DPT.DPObject):
    ...
    def create(self, *args, **kwargs):
        ...
        # Storing array number
        aname = DPT.levels.normpath(os.path.dirname(pwd)) 
        
        # Creating a dictionary to keep track of items in specific arrays
        self.array_dict = dict()
        self.array_dict[aname] = 0
        
        # Keep track of the number of data sets (channels)
        self.numSets = 1
    ...
    def append(self, wf):
        ...
        # The number in array_dict thus keeps track of the last index in self.data that belongs to each array
    ...
    def plot(self, i = None, ax = None, getNumEvents = False, getLevels = False,\
        ...
        if plot_type == 'Channel':
            ...
            # Automatically switches off Labels, Ticks and Titles in array view
